...
class MNISTModel(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(64, 128, 3, 1)  # 第三层
    ...
    def forward(self, x):
        ...
        x = torch.max_pool2d(x, 2)          # 池化后变为 11x11
        
        x = self.dropout1(x)
        x = torch.flatten(x, 1)              # 展平为 15488 维
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        print("示例：")
        print("  训练:  & C:/Users/17153/miniconda3/python.exe c:/Users/17153/Desktop/ai/demo3.py --train ")
        print("  评估:  & C:/Users/17153/miniconda3/python.exe c:/Users/17153/Desktop/ai/demo3.py --eval")
        print("  预测: & C:/Users/17153/miniconda3/python.exe c:/Users/17153/Desktop/ai/demo3.py--predict picture")
        print("  指定模型:& C:/Users/17153/miniconda3/python.exe c:/Users/17153/Desktop/ai/demo3.py --predict picture --model_path models/")