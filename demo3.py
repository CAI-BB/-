...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        print("示例：")
        print("  训练:  & C:/ /miniconda3/python.exe c:/ /Desktop/ai/demo3.py --train ")
        print("  评估:  & C:/ /miniconda3/python.exe c:/ /Desktop/ai/demo3.py --eval")
        print("  预测: & C:/ /miniconda3/python.exe c:/ /Desktop/ai/demo3.py--predict picture")
        print("  指定模型:& C:/ /miniconda3/python.exe c:/ /Desktop/ai/demo3.py --predict picture --model_path models/")